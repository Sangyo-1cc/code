...
// 디버그 모드
const DEBUG_MODE = false; // 사용자에게는 보이지 않도록 false로 변경
...
async function downloadResult() {
    ...
    ctx.roundRect(leftPanelX, leftPanelY, panelWidth, 500, 30);
    ...
    if (mainFeedback) {
        ...
        ctx.roundRect(rightPanelX, feedbackY, panelWidth, 300, 30);
...
async function shareToInstagram() {
    ...
    // 위의 downloadResult와 동일한 이미지 생성 코드
    // ... (동일한 이미지 생성 로직)
...
console.log('[AI Squat] 스크립트 로드 완료. 디버그: window.aiSquatDebug()');.depth + '점';
